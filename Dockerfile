...
# Force token authentication for fetching LambdaTest repos
RUN git config --global  url."https://${GITHUB_TOKEN}:x-oauth-basic@github.com/LambdaTest".insteadOf "https://github.com/LambdaTest"
